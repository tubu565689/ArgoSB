...
### 7、如果需要多样的功能，推荐使用VPS专用四合一脚本[sing-box-yg](https://github.com/tubu565689/sing-box-yg)
...
```
vlpt="" vmpt="" hypt="" tupt="" uuid="" reym="" argo="" agn="" agk="" ip="" bash <(curl -Ls https://raw.githubusercontent.com/tubu565689/argosb/main/argosb.sh)
```
...
```
vlpt="" vmpt="" hypt="" tupt="" argo="y" agn="" agk="" bash <(curl -Ls https://raw.githubusercontent.com/tubu565689/argosb/main/argosb.sh)
```
...
```
vmpt="" argo="y" agn="" agk="" bash <(curl -Ls https://raw.githubusercontent.com/tubu565689/argosb/main/argosb.sh)
```
...
```
hypt="" bash <(curl -Ls https://raw.githubusercontent.com/tubu565689/argosb/main/argosb.sh)
```
...
```agsb list``` 或者 ```bash <(curl -Ls https://raw.githubusercontent.com/tubu565689/argosb/main/argosb.sh) list```
...
```ip=4 agsb list```或者```ip=4 bash <(curl -Ls https://raw.githubusercontent.com/tubu565689/argosb/main/argosbx.sh) list```

显示IPV6节点配置：

```ip=6 agsb list```或者```ip=6 bash <(curl -Ls https://raw.githubusercontent.com/tubu565689/argosb/main/argosbx.sh) list```

 3、卸载脚本：

```agsb del``` 或者 ```bash <(curl -Ls https://raw.githubusercontent.com/tubu565689/argosb/main/argosb.sh) del```
...
----------------------------------------------------------
### 感谢你右上角的star🌟
[![Stargazers over time](https://starchart.cc/tubu565689/ArgoSB.svg)](https://starchart.cc/tubu565689/ArgoSB)
